...
const int stepsPerRevolution = 570;  // change this to fit the number of steps per revolution
// for your motor
...
int stepCount = 5.7;  // number of steps the motor has taken
boolean stepperFlag= false;
